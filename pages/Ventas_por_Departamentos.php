...
<form class="form-inline"> <label for="">Fecha:</label>
    ...
    <button type="button" id="Consultar" class="btn btn-success" onclick="getDataX();" margin-bottom:30px;">Consultar
        <span id="charge1"><i class="fa fa-circle-o-notch fa-spin"></i></span></button>
</form>

<div class="box box-primary">
    <div class="box-header width-border">
        <center>
            <h1 class="header">Ventas por Departamentos</h1>
        </center>
    </div>
    <form class="form-box">
...
<div class="box-body">
    <table id="example" class="display responsive nowrap"
        style="width:100%; display: none; font-weight: normal !important;">
